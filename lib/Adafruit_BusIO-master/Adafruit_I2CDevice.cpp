 ...
 *    @param  theWire The I2C bus to use, defaults to &softI2C
 */
Adafruit_I2CDevice::Adafruit_I2CDevice(uint8_t addr, SoftI2C *theWire) {
  _addr = addr;
  _wire = theWire;
  _begun = false;
#ifdef ARDUINO_ARCH_SAMD
  _maxBufferSize = 250; // as defined in SoftI2C.h's RingBuffer
#elif defined(ESP32)
